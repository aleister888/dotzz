...
enum { SchemeNorm, SchemeSel, SchemeScratchNorm,  /* color schemes */
...
struct Client {
	...
	int bw, oldbw;
	unsigned int tags;
	int isfixed, isfloating, isurgent, neverfocus, oldstate, isfullscreen, issticky, isfakefullscreen, isterminal, noswallow;
	pid_t pid;
	char scratchkey;
	Client *next;
	Client *snext;
